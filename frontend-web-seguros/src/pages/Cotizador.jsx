        ...
        <div className="cotizador-box">
          ...
          <div className="cotizador-info">
            ...
            <ul>
              ...
              <li>
                Un asesor de Prieto & Correa se pondrá en contacto contigo.
              </li>
              <li>
                Te acompañamos para resolver dudas y comparar alternativas.
              </li>
              <li>
                Recibes una propuesta personalizada para tomar tu decisión.
              </li>
            </ul>
          </div>
        </div>
